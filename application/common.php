...
function get_order_info_print($orders_sn, $A, $B, $C, $D)
{
    ...
    $order_print_info .= '<LBOLD>电话：' . $order['user_address']->phone . '</LBOLD><BR>';
    $order_print_info .= '<LBOLD>地址：' . $order['user_address']->school_name . ' ' . $order['user_address']->area_detail . ' ' . $order['user_address']->house_number . '</LBOLD><BR>';
    $order_print_info .= '--------------------------------<BR>';
