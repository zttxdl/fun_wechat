...
CREATE TABLE `fun_advert` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='广告详情表';
...
CREATE TABLE `fun_agreement` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='图文协议表';
...
CREATE TABLE `fun_back` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='银行表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='食堂表';
...
CREATE TABLE `fun_canteen_income_expend` (
  ...
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=3251 DEFAULT CHARSET=utf8mb4 COMMENT='食堂收支明细表';
...
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='意见反馈表';
...
CREATE TABLE `fun_hot_search` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='热销搜索';

-- ----------------------------
-- Table structure for fun_hourse
-- ----------------------------
DROP TABLE IF EXISTS `fun_hourse`;
CREATE TABLE `fun_hourse` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `fid` int(11) DEFAULT '0' COMMENT '父级ID',
  `name` varchar(100) DEFAULT '' COMMENT '楼栋名称',
  `level` tinyint(1) DEFAULT '0' COMMENT '等级',
  `school_id` smallint(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='学生宿舍楼栋表';
...
CREATE TABLE `fun_invitation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=147 DEFAULT CHARSET=utf8mb4 COMMENT='邀请有奖记录表';

-- ----------------------------
-- Table structure for fun_jg_device
-- ----------------------------
DROP TABLE IF EXISTS `fun_jg_device`;
CREATE TABLE `fun_jg_device` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `shop_id` int(10) NOT NULL DEFAULT '0' COMMENT '店铺主键值',
  `device_type` varchar(30) NOT NULL DEFAULT '0' COMMENT '设备类型：''android''，''ios''',
  `device_sn` varchar(100) NOT NULL DEFAULT '0' COMMENT '设备型号',
  `update_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '记录/更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `shopid` (`shop_id`) USING BTREE
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商家入驻【意向表单】';
...
) ENGINE=InnoDB AUTO_INCREMENT=6378 DEFAULT CHARSET=utf8 COMMENT='我的红包';

-- ----------------------------
-- Table structure for fun_node
-- ----------------------------
DROP TABLE IF EXISTS `fun_node`;
CREATE TABLE `fun_node` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='全国菜单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3997 DEFAULT CHARSET=utf8mb4 COMMENT='订单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6547 DEFAULT CHARSET=utf8 COMMENT='订单详情表';
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='平台红包';
...
) ENGINE=InnoDB AUTO_INCREMENT=1188 DEFAULT CHARSET=utf8 COMMENT='商品信息表';
...
CREATE TABLE `fun_product_attr_classify` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=165 DEFAULT CHARSET=utf8 COMMENT='商品属性分类';
...
) ENGINE=InnoDB AUTO_INCREMENT=5304 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `fun_products_classify` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=utf8 COMMENT='商品分类表';
...
CREATE TABLE `fun_receiving_addr` (
  ...
  `longitude` double(10,6) NOT NULL DEFAULT '0.000000' COMMENT '经纬',
  `latitude` double(10,6) NOT NULL DEFAULT '0.000000' COMMENT '维度',
  `add_time` int(10) NOT NULL DEFAULT '0' COMMENT '记录时间',
  `hourse_id` int(11) DEFAULT '0' COMMENT '楼号主键ID',
  PRIMARY KEY (`id`),
  KEY `user_raddr` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2271 DEFAULT CHARSET=utf8 COMMENT='收货地址表';
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='退款表';
...
) ENGINE=InnoDB AUTO_INCREMENT=172 DEFAULT CHARSET=utf8 COMMENT='骑手评价表';
...
CREATE TABLE `fun_rider_income_expend` (
  ...
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=3377 DEFAULT CHARSET=utf8mb4 COMMENT='骑手收支明细表';
...
CREATE TABLE `fun_rider_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8 COMMENT='骑手信息表';
...
CREATE TABLE `fun_rider_recruit` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1未处理 2已处理 3不处理',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='骑手招募【意向表单】';
...
CREATE TABLE `fun_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='全国角色表';
...
CREATE TABLE `fun_school` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='学校表';
...
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8 COMMENT='历史搜索表';
...
) ENGINE=InnoDB AUTO_INCREMENT=172 DEFAULT CHARSET=utf8 COMMENT='商家评价表';
...
CREATE TABLE `fun_shop_comments_tips` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='评价标签与店铺关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='店铺满减券';
...
CREATE TABLE `fun_shop_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='商家信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='商家更多详情信息';
...
CREATE TABLE `fun_takeout` (
  ...
  `hourse_id` int(11) NOT NULL DEFAULT '0' COMMENT '楼栋ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `order_id` (`order_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3253 DEFAULT CHARSET=utf8mb4 COMMENT='外卖表';
...
CREATE TABLE `fun_today_deals` (
  ...
  `num` smallint(4) unsigned NOT NULL DEFAULT '0' COMMENT '商家限量',
  ...
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='今日特价表';
...
CREATE TABLE `fun_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3045 DEFAULT CHARSET=utf8 COMMENT='用户表';

-- ----------------------------
-- Table structure for fun_user_active
-- ----------------------------
DROP TABLE IF EXISTS `fun_user_active`;
CREATE TABLE `fun_user_active` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `save_time` date NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='用户活跃情况';

-- ----------------------------
-- Table structure for fun_user_new
-- ----------------------------
DROP TABLE IF EXISTS `fun_user_new`;
CREATE TABLE `fun_user_new` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `save_time` date NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='新用户情况';
...
CREATE TABLE `fun_withdraw` (
  ...
  KEY `type` (`type`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=3336 DEFAULT CHARSET=utf8mb4 COMMENT='商家提现表';
